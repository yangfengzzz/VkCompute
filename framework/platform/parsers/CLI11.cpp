...
namespace vox {
CLI11CommandContext::CLI11CommandContext(CLI::App *cli, const CLI11CommandContextState &state) : CommandParserContext(), cli11(cli), _state(state) {}
...
CLI11CommandParser::CLI11CommandParser(const std::string &name, const std::string &description, const std::vector<std::string> &args) : _cli11{std::make_unique<CLI::App>(description, name)}, _formatter{std::make_shared<HelpFormatter>()} {
