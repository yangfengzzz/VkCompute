...
Attachment::Attachment(VkFormat format, VkSampleCountFlagBits samples, VkImageUsageFlags usage) : format{format},
                                                                                                  samples{samples},
                                                                                                  usage{usage} {
}
...
vox::RenderTarget::RenderTarget(std::vector<core::Image> &&images) : device{images.back().get_device()},
...
vox::RenderTarget::RenderTarget(std::vector<core::ImageView> &&image_views) : device{const_cast<core::Image &>(image_views.back().get_image()).get_device()},
                                                                              images{},
