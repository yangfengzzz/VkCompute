...
class RenderContext {
public:
    std::function<void(std::vector<VkSemaphore> &, std::vector<VkPipelineStageFlags> &)> external_wait_semaphores = nullptr;
    std::function<void(std::vector<VkSemaphore> &)> external_signal_semaphores = nullptr;
