...
void fixed_len_sum(const T *val, T *sum, int value_size) {
...
template<typename T>
void dyn_len_sum(const T *val, T *sum, int value_size) {
...
template<int N, typename T>
void fixed_len_inner(const T *a, const T *b, T *dot, int value_size) {
...
template<typename T>
void dyn_len_inner(const T *a, const T *b, T *dot, int value_size) {
...
template<typename T>
void array_sum_host(const T *ptr_a, T *ptr_out, int count, int byte_stride, int type_length) {
