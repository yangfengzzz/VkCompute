...
option(VKB_WARNINGS_AS_ERRORS "Enable Warnings as Errors" OFF)
option(VKB_VALIDATION_LAYERS "Enable validation layers for every application." OFF)
option(VKB_VALIDATION_LAYERS_GPU_ASSISTED "Enable GPU assisted validation layers for every application (implicitly enables VKB_VALIDATION_LAYERS)." OFF)
option(VKB_VALIDATION_LAYERS_BEST_PRACTICES "Enable best practices validation layers for every application (implicitly enables VKB_VALIDATION_LAYERS)." OFF)
option(VKB_VALIDATION_LAYERS_SYNCHRONIZATION "Enable synchronization validation layers for every application (implicitly enables VKB_VALIDATION_LAYERS)." OFF)
option(VKB_VULKAN_DEBUG "Enable VK_EXT_debug_utils or VK_EXT_debug_marker if supported." ON)
option(VKB_BUILD_TESTS "Enable generation and building of Vulkan best practice tests." OFF)
